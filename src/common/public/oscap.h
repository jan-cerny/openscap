 ...
 */
OSCAP_EXPORT void oscap_init(void);
 ...
 */
OSCAP_EXPORT void oscap_cleanup(void);

/// Get version of the OpenSCAP library
OSCAP_EXPORT const char *oscap_get_version(void);
 ...
 */
OSCAP_EXPORT const char *oscap_document_type_to_string(oscap_document_type_t type);

OSCAP_EXPORT typedef int (*xml_reporter)(const char *file, int line, const char *msg, void *arg);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int oscap_validate_document(const char *xmlfile, oscap_document_type_t doctype, const char *version, xml_reporter reporter, void *arg));
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int oscap_schematron_validate_document(const char *xmlfile, oscap_document_type_t doctype, const char *version, const char *outfile));
 ...
 */
OSCAP_EXPORT int oscap_apply_xslt(const char *xmlfile, const char *xsltfile, const char *outfile, const char **params);

/**
 * Function returns path used to locate OpenSCAP XML schemas
 */
OSCAP_EXPORT const char * oscap_path_to_schemas(void);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(const char * oscap_path_to_schematron(void));

/**
 * Function returns path used to locate OpenSCAP Default CPE files
 */
OSCAP_EXPORT const char * oscap_path_to_cpe(void);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int oscap_determine_document_type(const char *document, oscap_document_type_t *doc_type));
