 ...
 */
OSCAP_EXPORT void __oscap_dlprintf(int level, const char *file, const char *fn, size_t line, int delta_indent, const char *fmt, ...);
 ...
 */
OSCAP_EXPORT bool oscap_set_verbose(const char *verbosity_level, const char *filename, bool is_probe);
 ...
 */
OSCAP_EXPORT oscap_verbosity_levels oscap_verbosity_level_from_cstr(const char *level_name);
