 ...
 */
OSCAP_EXPORT typedef void *(*xccdf_policy_engine_query_fn) (void *, xccdf_policy_engine_query_t, void *);
 ...
 */
OSCAP_EXPORT typedef xccdf_test_result_type_t (*xccdf_policy_engine_eval_fn) (struct xccdf_policy *policy, const char *rule_id, const char *definition_id, const char *href_if, struct xccdf_value_binding_iterator *value_binding_it, struct xccdf_check_import_iterator *check_imports_it, void *user_data);
 ...
 */
OSCAP_EXPORT struct xccdf_policy_model *xccdf_policy_model_new(struct xccdf_benchmark *benchmark);
 ...
 */
OSCAP_EXPORT struct xccdf_policy * xccdf_policy_new(struct xccdf_policy_model * model, struct xccdf_profile * profile);
 ...
 */
OSCAP_EXPORT struct xccdf_value_binding * xccdf_value_binding_new(void);

/** 
 * Destructor of Policy Model structure
 * @memberof xccdf_policy_model
 */
OSCAP_EXPORT void xccdf_policy_model_free(struct xccdf_policy_model *);

/** 
 * Destructor of Policy structure
 * @memberof xccdf_policy
 */
OSCAP_EXPORT void xccdf_policy_free(struct xccdf_policy *);

/** 
 * Destructor of Value binding structure
 * @memberof xccdf_value_binding
 */
OSCAP_EXPORT void xccdf_value_binding_free(struct xccdf_value_binding *);
 ...
 */
OSCAP_EXPORT bool xccdf_policy_model_set_tailoring(struct xccdf_policy_model *model, struct xccdf_tailoring *tailoring);

/**
 * Retrieves the Tailoring element used in this policy.
 * @memberof xccdf_policy_model
 */
OSCAP_EXPORT struct xccdf_tailoring *xccdf_policy_model_get_tailoring(struct xccdf_policy_model *model);
 ...
 */
OSCAP_EXPORT char *xccdf_policy_get_readable_item_title(struct xccdf_policy *policy, struct xccdf_item *item, const char *preferred_lang);
 ...
 * @returns plaintext C string which must be freed by caller
 */
OSCAP_EXPORT char *xccdf_policy_get_readable_item_description(struct xccdf_policy *policy, struct xccdf_item *item, const char *preferred_lang);

/**
 * Registers an additional CPE dictionary for applicability testing
 * The one embedded in the evaluated XCCDF take precedence!
 */
OSCAP_EXPORT bool xccdf_policy_model_add_cpe_dict_source(struct xccdf_policy_model * model, struct oscap_source *source);
 ...
 */
OSCAP_EXPORT bool xccdf_policy_model_add_cpe_dict(struct xccdf_policy_model * model, const char * cpe_dict);

/**
 * Registers an additional CPE lang model for applicability testing
 * The one embedded in the evaluated XCCDF take precedence!
 */
OSCAP_EXPORT bool xccdf_policy_model_add_cpe_lang_model_source(struct xccdf_policy_model * model, struct oscap_source *source);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(bool xccdf_policy_model_add_cpe_lang_model(struct xccdf_policy_model * model, const char *cpe_lang));
 ...
 * The one embedded in the evaluated XCCDF take precedence!
 */
OSCAP_EXPORT bool xccdf_policy_model_add_cpe_autodetect_source(struct xccdf_policy_model *model, struct oscap_source *source);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(bool xccdf_policy_model_add_cpe_autodetect(struct xccdf_policy_model *model, const char *filepath));
 ...
 */
OSCAP_EXPORT struct oscap_htable_iterator *xccdf_policy_model_get_cpe_oval_sessions(struct xccdf_policy_model *model);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(bool xccdf_policy_model_register_engine_callback(struct xccdf_policy_model * model, char * sys, void * func, void * usr));
 ...
 * @return true if callback registered succesfully, false otherwise
 */
OSCAP_EXPORT bool xccdf_policy_model_register_engine_and_query_callback(struct xccdf_policy_model *model, char *sys, xccdf_policy_engine_eval_fn eval_fn, void *usr, xccdf_policy_engine_query_fn query_fn);

OSCAP_EXPORT typedef int (*policy_reporter_output)(struct xccdf_rule_result *, void *);
 ...
 * @return true if callback registered succesfully, false otherwise
 */
OSCAP_EXPORT bool xccdf_policy_model_register_output_callback(struct xccdf_policy_model * model, policy_reporter_output func, void * usr);

OSCAP_EXPORT typedef int (*policy_reporter_start)(struct xccdf_rule *, void *);
 ...
 * @return true if callback registered succesfully, false otherwise
 */
OSCAP_EXPORT bool xccdf_policy_model_register_start_callback(struct xccdf_policy_model * model, policy_reporter_start func, void * usr);
 ...
 * @memberof xccdf_policy
 */
OSCAP_EXPORT struct xccdf_policy_model * xccdf_policy_get_model(const struct xccdf_policy * policy);
 ...
 * @memberof xccdf_policy_model
 */
OSCAP_EXPORT struct xccdf_benchmark * xccdf_policy_model_get_benchmark(const struct xccdf_policy_model * item);

/**
 * Get Value Bindings from XCCDF Policy
 * @memberof xccdf_policy
 */
OSCAP_EXPORT struct xccdf_value_binding_iterator  * xccdf_policy_get_values(const struct xccdf_policy * item);
 ...
 * @memberof xccdf_policy_model
 */
OSCAP_EXPORT struct xccdf_policy_iterator * xccdf_policy_model_get_policies(const struct xccdf_policy_model *model);
 ...
 * @return 0 on success
 */
OSCAP_EXPORT int xccdf_policy_model_build_all_useful_policies(struct xccdf_policy_model *policy_model);
 ...
 */
OSCAP_EXPORT struct xccdf_select_iterator * xccdf_policy_get_selected_rules(struct xccdf_policy *);
 ...
 */
OSCAP_EXPORT struct xccdf_profile * xccdf_policy_get_profile(const struct xccdf_policy *);
 ...
 */
OSCAP_EXPORT struct xccdf_select_iterator * xccdf_policy_get_selects(const struct xccdf_policy *);
 ...
 * @return String
 */
OSCAP_EXPORT char * xccdf_value_binding_get_name(const struct xccdf_value_binding *);
 ...
 * @return String
 */
OSCAP_EXPORT char * xccdf_value_binding_get_value(const struct xccdf_value_binding *);
 ...
 */
OSCAP_EXPORT xccdf_value_type_t xccdf_value_binding_get_type(const struct xccdf_value_binding *);
 ...
 */
OSCAP_EXPORT xccdf_operator_t xccdf_value_binding_get_operator(const struct xccdf_value_binding *);
 ...
 * @return String
 */
OSCAP_EXPORT char * xccdf_value_binding_get_setvalue(const struct xccdf_value_binding *);

/**
 * Get results of all XCCDF Policy results
 * @memberof xccdf_policy_model
 */
OSCAP_EXPORT struct xccdf_result_iterator * xccdf_policy_get_results(const struct xccdf_policy * policy);
 ...
 */
OSCAP_EXPORT struct xccdf_result * xccdf_policy_get_result_by_id(struct xccdf_policy * policy, const char * id);
 ...
 */
OSCAP_EXPORT const char * xccdf_policy_get_id(struct xccdf_policy * policy);
 ...
 * @return XCCDF Policy
 */
OSCAP_EXPORT struct xccdf_policy * xccdf_policy_model_get_policy_by_id(struct xccdf_policy_model * policy_model, const char * id);
 ...
 */
OSCAP_EXPORT bool xccdf_policy_model_add_policy(struct xccdf_policy_model *, struct xccdf_policy *);
 ...
 */
OSCAP_EXPORT bool xccdf_policy_add_select(struct xccdf_policy *, struct xccdf_select *);
 ...
 * @memberof xccdf_policy_model
 */
OSCAP_EXPORT bool xccdf_policy_add_result(struct xccdf_policy * policy, struct xccdf_result * item);
 ...
 * @return true if rule has been added succesfully
 */
OSCAP_EXPORT bool xccdf_policy_add_value(struct xccdf_policy *, struct xccdf_value_binding *);
 ...
 */
OSCAP_EXPORT bool xccdf_policy_is_item_selected(struct xccdf_policy *policy, const char *id);

/**
 * Retrieves number of selected items in the policy
 * @note This is meant to be used to estimate scanning progress for example.
 */
OSCAP_EXPORT int xccdf_policy_get_selected_rules_count(struct xccdf_policy *policy);
 ...
 * @return XCCDF Select
 */
OSCAP_EXPORT struct xccdf_select * xccdf_policy_get_select_by_id(struct xccdf_policy * policy, const char *item_id);
 ...
 * \code
OSCAP_EXPORT  * struct oval_agent_session * sess = oval_agent_new_session((struct oval_definition_model *) model, "name-of-file");
 * \endcode
 * */
OSCAP_EXPORT struct xccdf_result *  xccdf_policy_evaluate(struct xccdf_policy * policy);
 ...
 * @memberof xccdf_policy
 */
OSCAP_EXPORT bool xccdf_policy_resolve(struct xccdf_policy * policy);
 ...
 */
OSCAP_EXPORT int xccdf_policy_generate_fix(struct xccdf_policy *policy, struct xccdf_result *result, const char *sys, int output_fd);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(struct xccdf_item * xccdf_policy_tailor_item(struct xccdf_policy * policy, struct xccdf_item * item));
...
OSCAP_EXPORT struct oscap_file_entry *oscap_file_entry_new(void);
/// @memberof oscap_file_entry
OSCAP_EXPORT struct oscap_file_entry *oscap_file_entry_dup(struct oscap_file_entry* file_entry);
/// @memberof oscap_file_entry
OSCAP_EXPORT void oscap_file_entry_free(struct oscap_file_entry* entry);
/// @memberof oscap_file_entry
OSCAP_EXPORT const char* oscap_file_entry_get_system(struct oscap_file_entry* entry);
/// @memberof oscap_file_entry
OSCAP_EXPORT const char* oscap_file_entry_get_file(struct oscap_file_entry* entry);
...
OSCAP_EXPORT const struct oscap_file_entry *oscap_file_entry_iterator_next(struct oscap_file_entry_iterator *it);
/// @memberof oscap_file_entry_iterator
OSCAP_EXPORT bool oscap_file_entry_iterator_has_more(struct oscap_file_entry_iterator *it);
/// @memberof oscap_file_entry_iterator
OSCAP_EXPORT void oscap_file_entry_iterator_free(struct oscap_file_entry_iterator *it);
/// @memberof oscap_file_entry_iterator
OSCAP_EXPORT void oscap_file_entry_iterator_reset(struct oscap_file_entry_iterator *it);
...
OSCAP_EXPORT struct oscap_file_entry_list* oscap_file_entry_list_new(void);
/// @memberof oscap_file_entry_list
OSCAP_EXPORT void oscap_file_entry_list_free(struct oscap_file_entry_list* list);
/// @memberof oscap_file_entry_list
OSCAP_EXPORT struct oscap_file_entry_iterator* oscap_file_entry_list_get_files(struct oscap_file_entry_list* list);
 ...
 */
OSCAP_EXPORT struct oscap_file_entry_list * xccdf_policy_model_get_systems_and_files(struct xccdf_policy_model * policy_model);
 ...
 * The resulting list should be freed with oscap_filelist_free.
 */
OSCAP_EXPORT struct oscap_file_entry_list * xccdf_item_get_systems_and_files(struct xccdf_item * item);
 ...
 * of rule after evaluation will be "Not checked"
 */
OSCAP_EXPORT struct oscap_stringlist * xccdf_policy_model_get_files(struct xccdf_policy_model * policy_model);
 ...
 * of rule after evaluation will be "Not checked"
 */
OSCAP_EXPORT struct oscap_stringlist * xccdf_item_get_files(struct xccdf_item * item);
 ...
 */
OSCAP_EXPORT xccdf_test_result_type_t xccdf_test_result_resolve_and_operation(xccdf_test_result_type_t A, xccdf_test_result_type_t B);
 ...
 */
OSCAP_EXPORT bool xccdf_policy_iterator_has_more(struct xccdf_policy_iterator *it);

/**
 * Return the next xccdf_policy structure from the list and increment the iterator
 * @memberof xccdf_policy_iterator
 */
OSCAP_EXPORT struct xccdf_policy * xccdf_policy_iterator_next(struct xccdf_policy_iterator *it);

/**
 * Free the iterator structure (it makes no changes to the list structure)
 * @memberof xccdf_policy_iterator
 */
OSCAP_EXPORT void xccdf_policy_iterator_free(struct xccdf_policy_iterator *it);

/**
 * Reset the iterator structure (it will point to the first item in the list)
 * @memberof xccdf_policy_iterator
 */
OSCAP_EXPORT void xccdf_policy_iterator_reset(struct xccdf_policy_iterator *it);

/**
 * Return true if the list is not empty, false otherwise
 * @memberof xccdf_value_binding_iterator
 */
OSCAP_EXPORT bool xccdf_value_binding_iterator_has_more(struct xccdf_value_binding_iterator *it);

/**
 * Return the next xccdf_value_binding structure from the list and increment the iterator
 * @memberof xccdf_value_binding_iterator
 */
OSCAP_EXPORT struct xccdf_value_binding * xccdf_value_binding_iterator_next(struct xccdf_value_binding_iterator *it);

/**
 * Free the iterator structure (it makes no changes to the list structure)
 * @memberof xccdf_value_binding_iterator
 */
OSCAP_EXPORT void xccdf_value_binding_iterator_free(struct xccdf_value_binding_iterator *it);

/**
 * Reset the iterator structure (it will point to the first item in the list)
 * @memberof xccdf_value_binding_iterator
 */
OSCAP_EXPORT void xccdf_value_binding_iterator_reset(struct xccdf_value_binding_iterator *it);
 ...
 * @return XCCDF Score
 */
OSCAP_EXPORT struct xccdf_score * xccdf_policy_get_score(struct xccdf_policy * policy, struct xccdf_result * test_result, const char * system);
 ...
 */
OSCAP_EXPORT int xccdf_policy_recalculate_score(struct xccdf_policy * policy, struct xccdf_result * test_result);
 ...
 */
OSCAP_EXPORT const char *xccdf_policy_get_value_of_item(struct xccdf_policy * policy, struct xccdf_item * item);
 ...
 */
OSCAP_EXPORT char* xccdf_policy_substitute(const char *text, struct xccdf_policy *policy);
