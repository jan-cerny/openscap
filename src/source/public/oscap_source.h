 ...
 */
OSCAP_EXPORT struct oscap_source *oscap_source_new_from_file(const char *filepath);
 ...
 */
OSCAP_EXPORT struct oscap_source *oscap_source_new_from_memory(const char *buffer, size_t size, const char *filepath);
 ...
 */
OSCAP_EXPORT struct oscap_source *oscap_source_clone(struct oscap_source *old);

/**
 * Dispose oscap_source structure.
 * @param source Resource to dispose
 */
OSCAP_EXPORT void oscap_source_free(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT const char *oscap_source_get_filepath(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT oscap_document_type_t oscap_source_get_scap_type(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT const char *oscap_source_get_schema_version(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT int oscap_source_validate(struct oscap_source *source, xml_reporter reporter, void *user);
 ...
 * @returns 0 on pass; 1 on fail, and -1 on internal error
 */
OSCAP_EXPORT int oscap_source_validate_schematron(struct oscap_source *source, const char *outfile);
 ...
 */
OSCAP_EXPORT const char *oscap_source_readable_origin(const struct oscap_source *source);
 ...
 */
OSCAP_EXPORT int oscap_source_save_as(struct oscap_source *source, const char *filename);
 ...
 */
OSCAP_EXPORT int oscap_source_get_raw_memory(struct oscap_source *source, char **buffer, size_t *size);
