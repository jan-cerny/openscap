 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int ds_sds_decompose(const char* input_file, const char* id, const char* xccdf_id, const char* target_dir, const char* target_filename));
 ...
 *     instread. This function may be dropped from later versions of the library.
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int ds_sds_decompose_custom(const char* input_file, const char* id, const char* target_dir, const char* container_name, const char* component_id, const char* target_filename));
 ...
 * 	   -1 in case of errors
 */
OSCAP_EXPORT int ds_sds_compose_from_xccdf(const char* xccdf_file, const char* target_datastream);
 ...
 */
OSCAP_EXPORT int ds_sds_compose_add_component(const char *target_datastream, const char *datastream_id, const char *new_component, bool extended);

/**
 * @deprecated This function has been deprecated. Make a use of ds_rds_session
 * instread. This function may be dropped from later versions of the library.
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int ds_rds_decompose(const char* input_file, const char* report_id, const char* request_id, const char* target_dir));
...
OSCAP_EXPORT struct ds_stream_index* ds_stream_index_new(void);
/// @memberof ds_stream_index
OSCAP_EXPORT void ds_stream_index_free(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT const char* ds_stream_index_get_id(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT const char* ds_stream_index_get_timestamp(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT const char* ds_stream_index_get_version(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT struct oscap_string_iterator* ds_stream_index_get_checks(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT struct oscap_string_iterator* ds_stream_index_get_checklists(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT struct oscap_string_iterator* ds_stream_index_get_dictionaries(struct ds_stream_index* s);
 ...
 * @memberof ds_stream_index
 */
OSCAP_EXPORT struct oscap_string_iterator* ds_stream_index_get_extended_components(struct ds_stream_index* s);
...
OSCAP_EXPORT struct ds_sds_index* ds_sds_index_new(void);
/// @memberof ds_sds_index
OSCAP_EXPORT void ds_sds_index_free(struct ds_sds_index* s);
 ...
 * @memberof ds_sds_index
 */
OSCAP_EXPORT struct ds_stream_index* ds_sds_index_get_stream(struct ds_sds_index* s, const char* stream_id);
 ...
 * @memberof ds_sds_index
 */
OSCAP_EXPORT struct ds_stream_index_iterator* ds_sds_index_get_streams(struct ds_sds_index* s);
 ...
 *     instread. This function may be dropped from later versions of the library.
 */
OSCAP_EXPORT OSCAP_DEPRECATED(struct ds_sds_index *ds_sds_index_import(const char* file));
...
OSCAP_EXPORT struct ds_stream_index *ds_stream_index_iterator_next(struct ds_stream_index_iterator *it);
/// @memberof ds_stream_index_iterator
OSCAP_EXPORT bool ds_stream_index_iterator_has_more(struct ds_stream_index_iterator *it);
/// @memberof ds_stream_index_iterator
OSCAP_EXPORT void ds_stream_index_iterator_free(struct ds_stream_index_iterator *it);
...
OSCAP_EXPORT struct rds_report_request_index* rds_report_request_index_new(void);
OSCAP_EXPORT void rds_report_request_index_free(struct rds_report_request_index* s);
OSCAP_EXPORT const char* rds_report_request_index_get_id(struct rds_report_request_index* s);
...
OSCAP_EXPORT struct rds_asset_index* rds_asset_index_new(void);
OSCAP_EXPORT void rds_asset_index_free(struct rds_asset_index* s);
OSCAP_EXPORT const char* rds_asset_index_get_id(struct rds_asset_index* s);
OSCAP_EXPORT void rds_asset_index_add_report_ref(struct rds_asset_index* s, struct rds_report_index* report);
OSCAP_EXPORT struct rds_report_index_iterator* rds_asset_index_get_reports(struct rds_asset_index* s);

OSCAP_EXPORT struct rds_report_index* rds_report_index_new(void);
OSCAP_EXPORT void rds_report_index_free(struct rds_report_index* s);
OSCAP_EXPORT const char* rds_report_index_get_id(struct rds_report_index* s);
OSCAP_EXPORT void rds_report_index_set_request(struct rds_report_index* s, struct rds_report_request_index *request);
OSCAP_EXPORT struct rds_report_request_index *rds_report_index_get_request(struct rds_report_index* s);
...
OSCAP_EXPORT struct rds_report_request_index *rds_report_request_index_iterator_next(struct rds_report_request_index_iterator *it);
/// @memberof rds_report_request_index_iterator
OSCAP_EXPORT bool rds_report_request_index_iterator_has_more(struct rds_report_request_index_iterator *it);
/// @memberof rds_report_request_index_iterator
OSCAP_EXPORT void rds_report_request_index_iterator_free(struct rds_report_request_index_iterator *it);
...
OSCAP_EXPORT struct rds_asset_index *rds_asset_index_iterator_next(struct rds_asset_index_iterator *it);
/// @memberof rds_asset_index_iterator
OSCAP_EXPORT bool rds_asset_index_iterator_has_more(struct rds_asset_index_iterator *it);
/// @memberof rds_asset_index_iterator
OSCAP_EXPORT void rds_asset_index_iterator_free(struct rds_asset_index_iterator *it);
...
OSCAP_EXPORT struct rds_report_index *rds_report_index_iterator_next(struct rds_report_index_iterator *it);
/// @memberof rds_report_index_iterator
OSCAP_EXPORT bool rds_report_index_iterator_has_more(struct rds_report_index_iterator *it);
/// @memberof rds_report_index_iterator
OSCAP_EXPORT void rds_report_index_iterator_free(struct rds_report_index_iterator *it);
...
/// @memberof rds_index
OSCAP_EXPORT struct rds_index* rds_index_new(void);
/// @memberof rds_index
OSCAP_EXPORT void rds_index_free(struct rds_index *s);

/// @memberof rds_index
OSCAP_EXPORT struct rds_report_request_index_iterator *rds_index_get_report_requests(struct rds_index *s);
/// @memberof rds_index
OSCAP_EXPORT struct rds_asset_index_iterator *rds_index_get_assets(struct rds_index *s);
/// @memberof rds_index
OSCAP_EXPORT struct rds_report_index_iterator *rds_index_get_reports(struct rds_index *s);

/// @memberof rds_index
OSCAP_EXPORT struct rds_report_request_index *rds_index_get_report_request(struct rds_index *rds, const char *id);
/// @memberof rds_index
OSCAP_EXPORT struct rds_asset_index *rds_index_get_asset(struct rds_index *rds, const char *id);
/// @memberof rds_index
OSCAP_EXPORT struct rds_report_index *rds_index_get_report(struct rds_index *rds, const char *id);
 ...
 * instread. This function may be dropped from later versions of the library.
 */
OSCAP_EXPORT OSCAP_DEPRECATED(struct rds_index *rds_index_import(const char *file));

/// @memberof rds_index
OSCAP_EXPORT int rds_index_select_report(struct rds_index *s, const char **report_id);
