 ...
 */
OSCAP_EXPORT struct ds_rds_session *ds_rds_session_new_from_source(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT void ds_rds_session_free(struct ds_rds_session *rds_session);
 ...
 */
OSCAP_EXPORT struct rds_index *ds_rds_session_get_rds_idx(struct ds_rds_session *session);
 ...
 */
OSCAP_EXPORT int ds_rds_session_set_target_dir(struct ds_rds_session *session, const char *target_dir);
 ...
 */
OSCAP_EXPORT int ds_rds_session_dump_component_files(struct ds_rds_session *session);
 ...
 */
OSCAP_EXPORT struct oscap_source *ds_rds_session_select_report(struct ds_rds_session *session, const char *report_id);
 ...
 * @returns oscap_source owned by the ds_rds_session or NULL on error
 */
OSCAP_EXPORT struct oscap_source *ds_rds_session_select_report_request(struct ds_rds_session *session, const char *report_request_id);
 ...
 * @returns 0 on success
 */
OSCAP_EXPORT int ds_rds_session_replace_report_with_source(struct ds_rds_session *session, struct oscap_source *source);
 ...
 */
OSCAP_EXPORT char *ds_rds_session_get_html_report(struct ds_rds_session *rds_session);
