 ...
 */
OSCAP_EXPORT struct ds_sds_session *ds_sds_session_new_from_source(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT struct ds_sds_index *ds_sds_session_get_sds_idx(struct ds_sds_session *session);

/**
 * Dispose ds_sds_session structure.
 * @param sds_session Registry to dispose
 */
OSCAP_EXPORT void ds_sds_session_free(struct ds_sds_session *sds_session);
 ...
 */
OSCAP_EXPORT struct oscap_source *ds_sds_session_select_checklist(struct ds_sds_session *session, const char *datastream_id, const char *component_id, const char *benchmark_id);
 ...
 */
OSCAP_EXPORT struct oscap_source *ds_sds_session_select_tailoring(struct ds_sds_session *session, const char *component_id);
 ...
 */
OSCAP_EXPORT int ds_sds_session_set_datastream_id(struct ds_sds_session *session, const char *datastream_id);
 ...
 */
OSCAP_EXPORT const char *ds_sds_session_get_datastream_id(const struct ds_sds_session *session);
 ...
 */
OSCAP_EXPORT const char *ds_sds_session_get_checklist_id(const struct ds_sds_session *session);
 ...
 */
OSCAP_EXPORT struct oscap_source *ds_sds_session_get_component_by_href(struct ds_sds_session *session, const char *href);
 ...
 */
OSCAP_EXPORT bool ds_sds_session_can_register_component(struct ds_sds_session *session, const char *container_name, const char *component_id);
 ...
 * @returns 0 on success
 */
OSCAP_EXPORT int ds_sds_session_register_component_with_dependencies(struct ds_sds_session *session, const char *container_name, const char *component_id, const char *target_filename);
 ...
 * @returns 0 on success
 */
OSCAP_EXPORT int ds_sds_session_dump_component_files(struct ds_sds_session *session);
 ...
 * @returns 0 on success
 */
OSCAP_EXPORT int ds_sds_session_set_target_dir(struct ds_sds_session *session, const char *target_dir);
 ...
 */
OSCAP_EXPORT void ds_sds_session_reset(struct ds_sds_session *session);
 ...
 */
OSCAP_EXPORT void ds_sds_session_set_remote_resources(struct ds_sds_session *session, bool allowed, download_progress_calllback_t callback);
 ...
 */
OSCAP_EXPORT char *ds_sds_session_get_html_guide(struct ds_sds_session *session, const char *profile_id);
