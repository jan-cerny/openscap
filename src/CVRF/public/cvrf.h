 ...
 */
OSCAP_EXPORT struct cvrf_product_status *cvrf_product_status_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_product_status_free(struct cvrf_product_status *status);
 ...
 */
OSCAP_EXPORT struct cvrf_product_status *cvrf_product_status_clone(const struct cvrf_product_status *stat);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_product_status_get_ids(struct cvrf_product_status *stat);
 ...
 */
OSCAP_EXPORT struct cvrf_threat *cvrf_threat_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_threat_free(struct cvrf_threat *threat);
 ...
 */
OSCAP_EXPORT struct cvrf_threat *cvrf_threat_clone(const struct cvrf_threat *threat);
 ...
 */
OSCAP_EXPORT const char *cvrf_threat_get_date(const struct cvrf_threat *threat);
 ...
 */
OSCAP_EXPORT const char *cvrf_threat_get_description(const struct cvrf_threat *threat);
 ...
 * @return Iterator for the stringlist of ProductIDs
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_threat_get_product_ids(struct cvrf_threat *threat);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_threat_get_group_ids(struct cvrf_threat *threat);
 ...
 */
OSCAP_EXPORT bool cvrf_threat_set_date(struct cvrf_threat *threat, const char *date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_threat_set_description(struct cvrf_threat *threat, const char *description);
 ...
 */
OSCAP_EXPORT struct cvrf_remediation *cvrf_remediation_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_remediation_free(struct cvrf_remediation *remed);
 ...
 */
OSCAP_EXPORT struct cvrf_remediation *cvrf_remediation_clone(const struct cvrf_remediation *remed);
 ...
 */
OSCAP_EXPORT const char *cvrf_remediation_get_date(const struct cvrf_remediation *remed);
 ...
 */
OSCAP_EXPORT const char *cvrf_remediation_get_description(const struct cvrf_remediation *remed);
 ...
 */
OSCAP_EXPORT const char *cvrf_remediation_get_url(const struct cvrf_remediation *remed);
 ...
 */
OSCAP_EXPORT const char *cvrf_remediation_get_entitlement(const struct cvrf_remediation *remed);
 ...
 * @return Iterator for the stringlist of ProductIDs
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_remediation_get_product_ids(struct cvrf_remediation *remed);
 ...
 * @return Iterator for the stringlist of GroupIDs
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_remediation_get_group_ids(struct cvrf_remediation *remed);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_remediation_set_date(struct cvrf_remediation *remed, const char *date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_remediation_set_description(struct cvrf_remediation *remed, const char *description);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_remediation_set_url(struct cvrf_remediation *remed, const char *url);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_remediation_set_entitlement(struct cvrf_remediation *remed, const char *entitlement);
 ...
 */
OSCAP_EXPORT struct cvrf_score_set *cvrf_score_set_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_score_set_free(struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT struct cvrf_score_set *cvrf_score_set_clone(const struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT const char *cvrf_score_set_get_vector(const struct cvrf_score_set *score_set);
 ...
 * @return Iterator for the stringlist of ProductIDs
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_score_set_get_product_ids(struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT struct cvss_impact *cvrf_score_set_get_impact(const struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT char *cvrf_score_set_get_base_score(const struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT char *cvrf_score_set_get_environmental_score(const struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT char *cvrf_score_set_get_temporal_score(const struct cvrf_score_set *score_set);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_score_set_set_vector(struct cvrf_score_set *score_set, const char *vector);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_score_set_set_impact(struct cvrf_score_set *score_set, struct cvss_impact *impact);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_score_set_add_metric(struct cvrf_score_set *score_set, enum cvss_category category, const char *score);
 ...
 */
OSCAP_EXPORT struct cvrf_involvement *cvrf_involvement_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_involvement_free(struct cvrf_involvement *involve);
 ...
 */
OSCAP_EXPORT struct cvrf_involvement *cvrf_involvement_clone(const struct cvrf_involvement *involve);
 ...
 */
OSCAP_EXPORT const char *cvrf_involvement_get_description(const struct cvrf_involvement *involve);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_involvement_set_description(struct cvrf_involvement *involve, const char *description);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability_cwe *cvrf_vulnerability_cwe_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_vulnerability_cwe_free(struct cvrf_vulnerability_cwe *cwe);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability_cwe *cvrf_vulnerability_cwe_clone(const struct cvrf_vulnerability_cwe *cwe);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_cwe_get_cwe(const struct cvrf_vulnerability_cwe *vuln_cwe);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_cwe_get_id(const struct cvrf_vulnerability_cwe *vuln_cwe);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_cwe_set_cwe(struct cvrf_vulnerability_cwe *vuln_cwe, const char *cwe);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_cwe_set_id(struct cvrf_vulnerability_cwe *vuln_cwe, const char *id);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability *cvrf_vulnerability_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_vulnerability_free(struct cvrf_vulnerability *vulnerability);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability *cvrf_vulnerability_clone(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT int cvrf_vulnerability_filter_by_product(struct cvrf_vulnerability *vuln, const char *prod);
 ...
 */
OSCAP_EXPORT int cvrf_vulnerability_get_ordinal(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_get_title(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_get_system_id(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_get_system_name(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_get_discovery_date(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_get_release_date(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT const char *cvrf_vulnerability_get_cve_id(const struct cvrf_vulnerability *vuln);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_ordinal(struct cvrf_vulnerability *vuln, int ordinal);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_title(struct cvrf_vulnerability *vuln, const char *vulnerability_title);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_system_id(struct cvrf_vulnerability *vuln, const char *id);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_system_name(struct cvrf_vulnerability *vuln, const char *sys_name);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_discovery_date(struct cvrf_vulnerability *vuln, const char *discovery_date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_release_date(struct cvrf_vulnerability *vuln, const char *release_date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_set_cve_id(struct cvrf_vulnerability *vuln, const char *cve_id);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_vulnerability_get_references(struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_vulnerability_get_acknowledgments(struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_vulnerability_get_notes(struct cvrf_vulnerability *vuln);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_add_vulnerability_cwe(struct cvrf_vulnerability *vuln, struct cvrf_vulnerability_cwe *vulnerability_cwe);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability_cwe_iterator *cvrf_vulnerability_get_vulnerability_cwes(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability_cwe *cvrf_vulnerability_cwe_iterator_next(struct cvrf_vulnerability_cwe_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_vulnerability_cwe_iterator_has_more(struct cvrf_vulnerability_cwe_iterator *it);
 ...
 * @param it CWE iterator structure
 */
OSCAP_EXPORT void cvrf_vulnerability_cwe_iterator_free(struct cvrf_vulnerability_cwe_iterator *it);
 ...
 * @param it CWE iterator structure
 */
OSCAP_EXPORT void cvrf_vulnerability_cwe_iterator_reset(struct cvrf_vulnerability_cwe_iterator *it);
 ...
 * @param it CWE iterator structure
 */
OSCAP_EXPORT void cvrf_vulnerability_cwe_iterator_remove(struct cvrf_vulnerability_cwe_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_add_involvement(struct cvrf_vulnerability *vuln, struct cvrf_involvement *involvement);
 ...
 */
OSCAP_EXPORT struct cvrf_involvement_iterator *cvrf_vulnerability_get_involvements(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_involvement *cvrf_involvement_iterator_next(struct cvrf_involvement_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_involvement_iterator_has_more(struct cvrf_involvement_iterator *it);
 ...
 * @param it CVRF Involvement iterator structure
 */
OSCAP_EXPORT void cvrf_involvement_iterator_free(struct cvrf_involvement_iterator *it);
 ...
 * @param it CVRF Involvement iterator structure
 */
OSCAP_EXPORT void cvrf_involvement_iterator_reset(struct cvrf_involvement_iterator *it);
 ...
 * @param it CVRF Involvement iterator structure
 */
OSCAP_EXPORT void cvrf_involvement_iterator_remove(struct cvrf_involvement_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_add_score_set(struct cvrf_vulnerability *vuln, struct cvrf_score_set *score_set);
 ...
 */
OSCAP_EXPORT struct cvrf_score_set_iterator *cvrf_vulnerability_get_score_sets(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_score_set *cvrf_score_set_iterator_next(struct cvrf_score_set_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_score_set_iterator_has_more(struct cvrf_score_set_iterator *it);
 ...
 * @param it CVRF ScoreSet iterator structure
 */
OSCAP_EXPORT void cvrf_score_set_iterator_free(struct cvrf_score_set_iterator *it);
 ...
 * @param it CVRF ScoreSet iterator structure
 */
OSCAP_EXPORT void cvrf_score_set_iterator_reset(struct cvrf_score_set_iterator *it);
 ...
 * @param it CVRF ScoreSet iterator structure
 */
OSCAP_EXPORT void cvrf_score_set_iterator_remove(struct cvrf_score_set_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_add_cvrf_product_status(struct cvrf_vulnerability *vuln, struct cvrf_product_status *stat);
 ...
 */
OSCAP_EXPORT struct cvrf_product_status_iterator *cvrf_vulnerability_get_product_statuses(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_product_status *cvrf_product_status_iterator_next(struct cvrf_product_status_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_product_status_iterator_has_more(struct cvrf_product_status_iterator *it);
 ...
 * @param it CVRF Status iterator structure
 */
OSCAP_EXPORT void cvrf_product_status_iterator_free(struct cvrf_product_status_iterator *it);
 ...
 * @param it CVRF Status iterator structure
 */
OSCAP_EXPORT void cvrf_product_status_iterator_reset(struct cvrf_product_status_iterator *it);
 ...
 * @param it CVRF Status iterator structure
 */
OSCAP_EXPORT void cvrf_product_status_iterator_remove(struct cvrf_product_status_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_add_remediation(struct cvrf_vulnerability *vuln, struct cvrf_remediation *remed);
 ...
 */
OSCAP_EXPORT struct cvrf_remediation_iterator *cvrf_vulnerability_get_remediations(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_remediation *cvrf_remediation_iterator_next(struct cvrf_remediation_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_remediation_iterator_has_more(struct cvrf_remediation_iterator *it);
 ...
 * @param it CVRF Remediation iterator structure
 */
OSCAP_EXPORT void cvrf_remediation_iterator_free(struct cvrf_remediation_iterator *it);
 ...
 * @param it CVRF Remediation iterator structure
 */
OSCAP_EXPORT void cvrf_remediation_iterator_reset(struct cvrf_remediation_iterator *it);
 ...
 * @param it CVRF Remediation iterator structure
 */
OSCAP_EXPORT void cvrf_remediation_iterator_remove(struct cvrf_remediation_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_vulnerability_add_threat(struct cvrf_vulnerability *vuln, struct cvrf_threat *threat);
 ...
 */
OSCAP_EXPORT struct cvrf_threat_iterator *cvrf_vulnerability_get_threats(const struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_threat *cvrf_threat_iterator_next(struct cvrf_threat_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_threat_iterator_has_more(struct cvrf_threat_iterator *it);
 ...
 * @param it CVRF Threat iterator structure
 */
OSCAP_EXPORT void cvrf_threat_iterator_free(struct cvrf_threat_iterator *it);
 ...
 * @param it CVRF Threat iterator structure
 */
OSCAP_EXPORT void cvrf_threat_iterator_reset(struct cvrf_threat_iterator *it);
 ...
 * @param it CVRF Threat iterator structure
 */
OSCAP_EXPORT void cvrf_threat_iterator_remove(struct cvrf_threat_iterator *it);
 ...
 */
OSCAP_EXPORT struct cvrf_product_name *cvrf_product_name_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_product_name_free(struct cvrf_product_name *full_name);
 ...
 */
OSCAP_EXPORT struct cvrf_product_name *cvrf_product_name_clone(const struct cvrf_product_name *full_name);
 ...
 */
OSCAP_EXPORT const char *cvrf_product_name_get_product_id(const struct cvrf_product_name *full_name);
 ...
 */
OSCAP_EXPORT const char *cvrf_product_name_get_cpe(const struct cvrf_product_name *full_name);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_product_name_set_product_id(struct cvrf_product_name *full_name, const char *product_id);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_product_name_set_cpe(struct cvrf_product_name *full_name, const char *cpe);
 ...
 */
OSCAP_EXPORT struct cvrf_group *cvrf_group_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_group_free(struct cvrf_group *group);
 ...
 */
OSCAP_EXPORT struct cvrf_group *cvrf_group_clone(const struct cvrf_group *group);
 ...
 */
OSCAP_EXPORT const char *cvrf_group_get_group_id(const struct cvrf_group *group);
 ...
 */
OSCAP_EXPORT const char *cvrf_group_get_description(const struct cvrf_group *group);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_group_set_group_id(struct cvrf_group *group, const char *group_id);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_group_set_description(struct cvrf_group *group, const char *description);
 ...
 * @return Iterator for the stringlist of ProductIDs
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_group_get_product_ids(struct cvrf_group *group);
 ...
 */
OSCAP_EXPORT struct cvrf_relationship *cvrf_relationship_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_relationship_free(struct cvrf_relationship *relationship);
 ...
 */
OSCAP_EXPORT struct cvrf_relationship *cvrf_relationship_clone(const struct cvrf_relationship *relation);
 ...
 */
OSCAP_EXPORT const char *cvrf_relationship_get_product_reference(const struct cvrf_relationship *relation);
 ...
 */
OSCAP_EXPORT const char *cvrf_relationship_get_relates_to_ref(const struct cvrf_relationship *relation);
 ...
 */
OSCAP_EXPORT struct cvrf_product_name *cvrf_relationship_get_product_name(const struct cvrf_relationship *relation);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_relationship_set_product_reference(struct cvrf_relationship *relation, const char *product_reference);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_relationship_set_relates_to_ref(struct cvrf_relationship *relation, const char *relates_to_ref);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_relationship_set_product_name(struct cvrf_relationship *relation, struct cvrf_product_name *name);
 ...
 */
OSCAP_EXPORT struct cvrf_branch *cvrf_branch_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_branch_free(struct cvrf_branch *branch);
 ...
 */
OSCAP_EXPORT struct cvrf_branch *cvrf_branch_clone(const struct cvrf_branch *branch);
 ...
 */
OSCAP_EXPORT const char *cvrf_branch_get_branch_name(const struct cvrf_branch *branch);
 ...
 */
OSCAP_EXPORT struct cvrf_product_name *cvrf_branch_get_product_name(const struct cvrf_branch *branch);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_branch_get_subbranches(struct cvrf_branch *branch);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_branch_set_branch_name(struct cvrf_branch *branch, const char *branch_name);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_branch_set_product_name(struct cvrf_branch *branch, struct cvrf_product_name *name);
 ...
 */
OSCAP_EXPORT struct cvrf_product_tree *cvrf_product_tree_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_product_tree_free(struct cvrf_product_tree *tree);
 ...
 */
OSCAP_EXPORT struct cvrf_product_tree *cvrf_product_tree_clone(const struct cvrf_product_tree *tree);
 ...
 */
OSCAP_EXPORT const char *get_cvrf_product_id_from_cpe(struct cvrf_product_tree *tree, const char *cpe);
 ...
 * @return 0 on success, -1 on failure
 */
OSCAP_EXPORT int cvrf_product_tree_filter_by_cpe(struct cvrf_product_tree *tree, const char *cpe);

/*---------------------------------------------------------------------*\
|				Iterators of child elements of ProductTree				|
\*---------------------------------------------------------------------*/

OSCAP_EXPORT struct oscap_iterator *cvrf_product_tree_get_branches(struct cvrf_product_tree *tree);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_product_tree_add_product_name(struct cvrf_product_tree *tree, struct cvrf_product_name *full_name);
 ...
 */
OSCAP_EXPORT struct cvrf_product_name_iterator *cvrf_product_tree_get_product_names(const struct cvrf_product_tree *tree);
 ...
 */
OSCAP_EXPORT struct cvrf_product_name *cvrf_product_name_iterator_next(struct cvrf_product_name_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_product_name_iterator_has_more(struct cvrf_product_name_iterator *it);
 ...
 * @param it CVRF FullProductName iterator structure
 */
OSCAP_EXPORT void cvrf_product_name_iterator_free(struct cvrf_product_name_iterator *it);
 ...
 * @param it CVRF FullProductName iterator structure
 */
OSCAP_EXPORT void cvrf_product_name_iterator_reset(struct cvrf_product_name_iterator *it);
 ...
 * @param it CVRF FullProductName iterator structure
 */
OSCAP_EXPORT void cvrf_product_name_iterator_remove(struct cvrf_product_name_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_product_tree_add_relationship(struct cvrf_product_tree *tree, struct cvrf_relationship *relation);
 ...
 */
OSCAP_EXPORT struct cvrf_relationship_iterator *cvrf_product_tree_get_relationships(const struct cvrf_product_tree *tree);
 ...
 */
OSCAP_EXPORT struct cvrf_relationship *cvrf_relationship_iterator_next(struct cvrf_relationship_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_relationship_iterator_has_more(struct cvrf_relationship_iterator *it);
 ...
 * @param it CVRF Relationship iterator structure
 */
OSCAP_EXPORT void cvrf_relationship_iterator_free(struct cvrf_relationship_iterator *it);
 ...
 * @param it CVRF Relationship iterator structure
 */
OSCAP_EXPORT void cvrf_relationship_iterator_reset(struct cvrf_relationship_iterator *it);
 ...
 * @param it CVRF Relationship iterator structure
 */
OSCAP_EXPORT void cvrf_relationship_iterator_remove(struct cvrf_relationship_iterator *it);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_product_tree_add_group(struct cvrf_product_tree *tree, struct cvrf_group *group);
 ...
 */
OSCAP_EXPORT struct cvrf_group_iterator *cvrf_product_tree_get_product_groups(const struct cvrf_product_tree *tree);
 ...
 */
OSCAP_EXPORT struct cvrf_group *cvrf_group_iterator_next(struct cvrf_group_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_group_iterator_has_more(struct cvrf_group_iterator *it);
 ...
 * @param it CVRF Group iterator structure
 */
OSCAP_EXPORT void cvrf_group_iterator_free(struct cvrf_group_iterator *it);
 ...
 * @param it CVRF Group iterator structure
 */
OSCAP_EXPORT void cvrf_group_iterator_reset(struct cvrf_group_iterator *it);
 ...
 * @param it CVRF Group iterator structure
 */
OSCAP_EXPORT void cvrf_group_iterator_remove(struct cvrf_group_iterator *it);
 ...
 */
OSCAP_EXPORT struct cvrf_acknowledgment *cvrf_acknowledgment_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_acknowledgment_free(struct cvrf_acknowledgment *ack);
 ...
 */
OSCAP_EXPORT struct cvrf_acknowledgment *cvrf_acknowledgment_clone(const struct cvrf_acknowledgment *ack);
 ...
 */
OSCAP_EXPORT const char *cvrf_acknowledgment_get_description(const struct cvrf_acknowledgment *ack);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_acknowledgment_set_description(struct cvrf_acknowledgment *ack, const char *description);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_acknowledgment_get_names(const struct cvrf_acknowledgment *ack);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_acknowledgment_get_organizations(const struct cvrf_acknowledgment *ack);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_acknowledgment_get_urls(const struct cvrf_acknowledgment *ack);
 ...
 */
OSCAP_EXPORT struct cvrf_note *cvrf_note_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_note_free(struct cvrf_note *note);
 ...
 */
OSCAP_EXPORT struct cvrf_note *cvrf_note_clone(const struct cvrf_note *note);
 ...
 */
OSCAP_EXPORT int cvrf_note_get_ordinal(const struct cvrf_note *note);
 ...
 */
OSCAP_EXPORT const char *cvrf_note_get_audience(const struct cvrf_note *note);
 ...
 */
OSCAP_EXPORT const char *cvrf_note_get_title(const struct cvrf_note *note);
 ...
 */
OSCAP_EXPORT const char *cvrf_note_get_contents(const struct cvrf_note *note);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_note_set_ordinal(struct cvrf_note *note, int ordinal);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_note_set_audience(struct cvrf_note *note, const char *audience);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_note_set_title(struct cvrf_note *note, const char *title);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_note_set_contents(struct cvrf_note *note, const char *contents);
 ...
 */
OSCAP_EXPORT struct cvrf_revision *cvrf_revision_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_revision_free(struct cvrf_revision *revision);
 ...
 */
OSCAP_EXPORT struct cvrf_revision *cvrf_revision_clone(const struct cvrf_revision *revision);
 ...
 */
OSCAP_EXPORT const char *cvrf_revision_get_number(const struct cvrf_revision *revision);
 ...
 */
OSCAP_EXPORT const char *cvrf_revision_get_date(const struct cvrf_revision *revision);
 ...
 */
OSCAP_EXPORT const char *cvrf_revision_get_description(const struct cvrf_revision *revision);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_revision_set_number(struct cvrf_revision *revision, const char *number);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_revision_set_date(struct cvrf_revision *revision, const char *date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_revision_set_description(struct cvrf_revision *revision, const char *description);
 ...
 */
OSCAP_EXPORT struct cvrf_doc_tracking *cvrf_doc_tracking_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_doc_tracking_free(struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT struct cvrf_doc_tracking *cvrf_doc_tracking_clone(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_tracking_get_tracking_id(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_doc_tracking_get_aliases(struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_tracking_get_version(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_tracking_get_init_release_date(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_tracking_get_cur_release_date(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_tracking_get_generator_engine(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_tracking_get_generator_date(const struct cvrf_doc_tracking *tracking);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_set_tracking_id(struct cvrf_doc_tracking *tracking, const char *id);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_set_version(struct cvrf_doc_tracking *tracking, const char *version);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_set_init_release_date(struct cvrf_doc_tracking *tracking, const char *init_release_date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_set_cur_release_date(struct cvrf_doc_tracking *tracking, const char *cur_release_date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_set_generator_engine(struct cvrf_doc_tracking *tracking, const char *generator_engine);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_set_generator_date(struct cvrf_doc_tracking *tracking, const char *generator_date);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_tracking_add_revision(struct cvrf_doc_tracking *tracking, struct cvrf_revision *revision);
 ...
 */
OSCAP_EXPORT struct cvrf_revision_iterator *cvrf_doc_tracking_get_revision_history(const struct cvrf_doc_tracking *tracking);
 ...
 */
OSCAP_EXPORT struct cvrf_revision *cvrf_revision_iterator_next(struct cvrf_revision_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_revision_iterator_has_more(struct cvrf_revision_iterator *it);
 ...
 * @param it CVRF Revision iterator structure
 */
OSCAP_EXPORT void cvrf_revision_iterator_free(struct cvrf_revision_iterator *it);
 ...
 * @param it CVRF Revision iterator structure
 */
OSCAP_EXPORT void cvrf_revision_iterator_reset(struct cvrf_revision_iterator *it);
 ...
 * @param it CVRF Revision iterator structure
 */
OSCAP_EXPORT void cvrf_revision_iterator_remove(struct cvrf_revision_iterator *it);
 ...
 */
OSCAP_EXPORT struct cvrf_doc_publisher *cvrf_doc_publisher_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_doc_publisher_free(struct cvrf_doc_publisher *publisher);
 ...
 */
OSCAP_EXPORT struct cvrf_doc_publisher *cvrf_doc_publisher_clone(const struct cvrf_doc_publisher *publisher);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_publisher_get_vendor_id(const struct cvrf_doc_publisher *publisher);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_publisher_get_contact_details(const struct cvrf_doc_publisher *publisher);
 ...
 */
OSCAP_EXPORT const char *cvrf_doc_publisher_get_issuing_authority(const struct cvrf_doc_publisher *publisher);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_publisher_set_vendor_id(struct cvrf_doc_publisher *publisher, const char *vendor_id);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_publisher_set_contact_details(struct cvrf_doc_publisher *publisher, const char *contact_details);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_doc_publisher_set_issuing_authority(struct cvrf_doc_publisher *publisher, const char *issuing_authority);
 ...
 */
OSCAP_EXPORT struct cvrf_reference *cvrf_reference_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_reference_free(struct cvrf_reference *reference);
 ...
 */
OSCAP_EXPORT struct cvrf_reference *cvrf_reference_clone(const struct cvrf_reference *ref);
 ...
 */
OSCAP_EXPORT const char *cvrf_reference_get_url(const struct cvrf_reference *reference);
 ...
 */
OSCAP_EXPORT const char *cvrf_reference_get_description(const struct cvrf_reference *reference);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_reference_set_url(struct cvrf_reference *reference, const char *url);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_reference_set_description(struct cvrf_reference *reference, const char *description);
 ...
 */
OSCAP_EXPORT struct cvrf_document *cvrf_document_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_document_free(struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct cvrf_document *cvrf_document_clone(const struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT const char *cvrf_document_get_doc_distribution(const struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT const char *cvrf_document_get_aggregate_severity(const struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT const char *cvrf_document_get_namespace(const struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct cvrf_doc_tracking *cvrf_document_get_tracking(const struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct cvrf_doc_publisher *cvrf_document_get_publisher(const struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_document_get_notes(struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_document_get_references(struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct oscap_iterator *cvrf_document_get_acknowledgments(struct cvrf_document *doc);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_document_set_doc_distribution(struct cvrf_document *doc, const char *distribution);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_document_set_aggregate_severity(struct cvrf_document *doc, const char *severity);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_document_set_namespace(struct cvrf_document *doc, const char *ns);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_document_set_publisher(struct cvrf_document *doc, struct cvrf_doc_publisher *publisher);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_document_set_tracking(struct cvrf_document *doc, struct cvrf_doc_tracking *track);
 ...
 */
OSCAP_EXPORT struct cvrf_model *cvrf_model_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_model_free(struct cvrf_model *cvrf);
 ...
 */
OSCAP_EXPORT struct cvrf_model *cvrf_model_clone(const struct cvrf_model *model);
 ...
 * @return 0 on success, -1 on failure
 */
OSCAP_EXPORT int cvrf_model_filter_by_cpe(struct cvrf_model *model, const char *cpe);
 ...
 */
OSCAP_EXPORT const char *cvrf_model_get_doc_title(const struct cvrf_model *model);
 ...
 */
OSCAP_EXPORT const char *cvrf_model_get_doc_type(const struct cvrf_model *model);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_model_set_doc_title(struct cvrf_model *model, const char *doc_title);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_model_set_doc_type(struct cvrf_model *model, const char *doc_type);
 ...
 */
OSCAP_EXPORT struct cvrf_product_tree *cvrf_model_get_product_tree(struct cvrf_model *model);
 ...
 */
OSCAP_EXPORT struct cvrf_document *cvrf_model_get_document(const struct cvrf_model *model);
 ...
 */
OSCAP_EXPORT const char *cvrf_model_get_identification(struct cvrf_model *model);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_model_set_document(struct cvrf_model *model, struct cvrf_document *doc);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability_iterator *cvrf_model_get_vulnerabilities(const struct cvrf_model *model);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_model_add_vulnerability(struct cvrf_model *model, struct cvrf_vulnerability *vuln);
 ...
 */
OSCAP_EXPORT struct cvrf_vulnerability *cvrf_vulnerability_iterator_next(struct cvrf_vulnerability_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_vulnerability_iterator_has_more(struct cvrf_vulnerability_iterator *it);
 ...
 * @param it CVRF Vulnerability iterator structure
 */
OSCAP_EXPORT void cvrf_vulnerability_iterator_free(struct cvrf_vulnerability_iterator *it);
 ...
 * @param it CVRF Vulnerability iterator structure
 */
OSCAP_EXPORT void cvrf_vulnerability_iterator_reset(struct cvrf_vulnerability_iterator *it);
 ...
 * @param it CVRF Vulnerability iterator structure
 */
OSCAP_EXPORT void cvrf_vulnerability_iterator_remove(struct cvrf_vulnerability_iterator *it);
 ...
 */
OSCAP_EXPORT struct cvrf_index *cvrf_index_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_index_free(struct cvrf_index *index);
 ...
 */
OSCAP_EXPORT struct cvrf_index *cvrf_index_clone(const struct cvrf_index *index);
 ...
 */
OSCAP_EXPORT const char *cvrf_index_get_source_url(const struct cvrf_index *index);
 ...
 */
OSCAP_EXPORT const char *cvrf_index_get_index_file(const struct cvrf_index *index);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_index_set_source_url(struct cvrf_index *index, const char *url);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_index_set_index_file(struct cvrf_index *index, const char *index_file);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_index_add_model(struct cvrf_index *index, struct cvrf_model *model);
 ...
 */
OSCAP_EXPORT struct cvrf_model_iterator *cvrf_index_get_models(const struct cvrf_index *index);
 ...
 */
OSCAP_EXPORT struct cvrf_model *cvrf_model_iterator_next(struct cvrf_model_iterator *it);
 ...
 */
OSCAP_EXPORT bool cvrf_model_iterator_has_more(struct cvrf_model_iterator *it);
 ...
 * @param it CVRF Model iterator structure
 */
OSCAP_EXPORT void cvrf_model_iterator_free(struct cvrf_model_iterator *it);
 ...
 * @param it CVRF Model iterator structure
 */
OSCAP_EXPORT void cvrf_model_iterator_reset(struct cvrf_model_iterator *it);
 ...
 * @param it CVRF Model iterator structure
 */
OSCAP_EXPORT void cvrf_model_iterator_remove(struct cvrf_model_iterator *it);
 ...
 */
OSCAP_EXPORT struct cvrf_session *cvrf_session_new_from_source_model(struct oscap_source *source);
 ...
 * @return CVRF session structure generated from this import source
 */
OSCAP_EXPORT struct cvrf_session *cvrf_session_new_from_source_index(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT void cvrf_session_free(struct cvrf_session *session);
 ...
 */
OSCAP_EXPORT struct cvrf_model *cvrf_session_get_model(struct cvrf_session *session);
 ...
 */
OSCAP_EXPORT struct cvrf_index *cvrf_session_get_index(const struct cvrf_session *session);
 ...
 */
OSCAP_EXPORT struct oscap_string_iterator *cvrf_session_get_product_ids(struct cvrf_session *session);
 ...
 */
OSCAP_EXPORT const char *cvrf_session_get_os_name(const struct cvrf_session *session);
 ...
 */
OSCAP_EXPORT void cvrf_session_set_model(struct cvrf_session *session, struct cvrf_model *model);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_session_set_index(struct cvrf_session *session, struct cvrf_index *index);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_session_set_os_name(struct cvrf_session *session, const char *os_name);
 ...
 */
OSCAP_EXPORT struct cvrf_rpm_attributes *cvrf_rpm_attributes_new(void);
 ...
 */
OSCAP_EXPORT void cvrf_rpm_attributes_free(struct cvrf_rpm_attributes *attributes);
 ...
 */
OSCAP_EXPORT const char *cvrf_rpm_attributes_get_full_package_name(const struct cvrf_rpm_attributes *attributes);
 ...
 */
OSCAP_EXPORT const char *cvrf_rpm_attributes_get_rpm_name(const struct cvrf_rpm_attributes *attributes);
 ...
 */
OSCAP_EXPORT const char *cvrf_rpm_attributes_get_evr_format(const struct cvrf_rpm_attributes *attributes);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_rpm_attributes_set_full_package_name(struct cvrf_rpm_attributes *attributes, const char *full_package);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_rpm_attributes_set_rpm_name(struct cvrf_rpm_attributes *attributes, const char *rpm_name);
 ...
 * @return true on success
 */
OSCAP_EXPORT bool cvrf_rpm_attributes_set_evr_format(struct cvrf_rpm_attributes *attributes, const char *evr_format);
 ...
 * @memberof cvrf_model
 */
OSCAP_EXPORT const char * cvrf_model_supported(void);
 ...
 */
OSCAP_EXPORT struct cvrf_index *cvrf_index_import(struct oscap_source *index_source);
 ...
 */
OSCAP_EXPORT struct cvrf_model *cvrf_model_import(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT struct oscap_source *cvrf_index_get_export_source(struct cvrf_index *index);
 ...
 */
OSCAP_EXPORT struct oscap_source *cvrf_model_get_export_source(struct cvrf_model *model);
 ...
 */
OSCAP_EXPORT struct oscap_source *cvrf_model_get_results_source(struct oscap_source *import_source, const char *os_name);
 ...
 * @return OSCAP source export target for the results XML file
 */
OSCAP_EXPORT struct oscap_source *cvrf_index_get_results_source(struct oscap_source *import_source, const char *os_name);
