 ...
 */
OSCAP_EXPORT struct xccdf_session *xccdf_session_new(const char *filename);
 ...
 * @retval NULL is returned in case of error. Details might be found through \ref oscap_err_desc()
 */
OSCAP_EXPORT struct xccdf_session *xccdf_session_new_from_source(struct oscap_source *source);
 ...
 */
OSCAP_EXPORT void xccdf_session_free(struct xccdf_session *session);

/**
 * Retrieves the filename the session was created with
 * @memberof xccdf_session
 */
OSCAP_EXPORT const char *xccdf_session_get_filename(const struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT bool xccdf_session_is_sds(const struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_rule(struct xccdf_session *session, const char *rule);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_validation(struct xccdf_session *session, bool validate, bool full_validation);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_thin_results(struct xccdf_session *session, bool thin_result);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_datastream_id(struct xccdf_session *session, const char *datastream_id);
 ...
 * @memberof xccdf_session
 */
OSCAP_EXPORT const char *xccdf_session_get_datastream_id(struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_component_id(struct xccdf_session *session, const char *component_id);
 ...
 * @memberof xccdf_session
 */
OSCAP_EXPORT const char *xccdf_session_get_component_id(struct xccdf_session *session);
 ...
 * @memberof xccdf_session
 */
OSCAP_EXPORT void xccdf_session_set_benchmark_id(struct xccdf_session *session, const char *benchmark_id);
 ...
 * @memberof xccdf_session
 */
OSCAP_EXPORT const char *xccdf_session_get_benchmark_id(struct xccdf_session *session);

/**
 * Retrieves the result id
 * @memberof xccdf_session
 */
OSCAP_EXPORT const char *xccdf_session_get_result_id(struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_user_cpe(struct xccdf_session *session, const char *user_cpe);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_user_tailoring_file(struct xccdf_session *session, const char *user_tailoring_file);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_user_tailoring_cid(struct xccdf_session *session, const char *user_tailoring_cid);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_remote_resources(struct xccdf_session *session, bool allowed, download_progress_calllback_t callback);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_loading_flags(struct xccdf_session *session, xccdf_session_loading_flags_t flags);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_custom_oval_files(struct xccdf_session *session, char **oval_filenames);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_custom_oval_eval_fn(struct xccdf_session *session, xccdf_policy_engine_eval_fn eval_fn);
 ...
 */
OSCAP_EXPORT bool xccdf_session_set_product_cpe(struct xccdf_session *session, const char *product_cpe);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_without_sys_chars_export(struct xccdf_session *session, bool without_sys_chars);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_oval_results_export(struct xccdf_session *session, bool to_export_oval_results);
 ...
 */
OSCAP_EXPORT void xccdf_session_set_check_engine_plugins_results_export(struct xccdf_session *session, bool to_export_results);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(void xccdf_session_set_sce_results_export(struct xccdf_session *session, bool to_export_sce_results));
 ...
 */
OSCAP_EXPORT void xccdf_session_set_oval_variables_export(struct xccdf_session *session, bool to_export_oval_variables);
 ...
 * @returns true on success
 */
OSCAP_EXPORT bool xccdf_session_set_xccdf_export(struct xccdf_session *session, const char *xccdf_file);
 ...
 * @returns true on success
 */
OSCAP_EXPORT bool xccdf_session_set_xccdf_stig_viewer_export(struct xccdf_session *session, const char *xccdf_stig_viewer_file);
 ...
 * @returns true on success
 */
OSCAP_EXPORT bool xccdf_session_set_arf_export(struct xccdf_session *session, const char *arf_file);
 ...
 * @returns true on success
 */
OSCAP_EXPORT bool xccdf_session_set_report_export(struct xccdf_session *session, const char *report_file);
 ...
 * @returns true on success
 */
OSCAP_EXPORT bool xccdf_session_set_profile_id(struct xccdf_session *session, const char *profile_id);
 ...
 */
OSCAP_EXPORT int xccdf_session_set_profile_id_by_suffix(struct xccdf_session *session, const char *profile_suffix);
 ...
 * @param session XCCDF Session
 */
OSCAP_EXPORT const char *xccdf_session_get_profile_id(struct xccdf_session *session);
 ...
 * @return sds index
 */
OSCAP_EXPORT struct ds_sds_index *xccdf_session_get_sds_idx(struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT int xccdf_session_load(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_load_xccdf(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_load_cpe(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_load_oval(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_load_check_engine_plugin2(struct xccdf_session *session, const char* plugin_name, bool quiet);
OSCAP_EXPORT int xccdf_session_load_check_engine_plugin(struct xccdf_session *session, const char* plugin_name);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_load_check_engine_plugins(struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int xccdf_session_load_sce(struct xccdf_session *session));
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_load_tailoring(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_evaluate(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_export_xccdf(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_export_oval(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_export_check_engine_plugins(struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int xccdf_session_export_sce(struct xccdf_session *session));
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_export_arf(struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT struct xccdf_policy_model *xccdf_session_get_policy_model(const struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT struct xccdf_policy *xccdf_session_get_xccdf_policy(const struct xccdf_session *session);
 ...
 * @returns the score
 */
OSCAP_EXPORT float xccdf_session_get_base_score(const struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT unsigned int xccdf_session_get_oval_agents_count(const struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT unsigned int xccdf_session_get_cpe_oval_agents_count(const struct xccdf_session *session);
 ...
 */
OSCAP_EXPORT bool xccdf_session_contains_fail_result(const struct xccdf_session *session);
 ...
 * @returns zero on success
 */
OSCAP_EXPORT int xccdf_session_remediate(struct xccdf_session *session);
 ...
 * @returns zero on success.
 */
OSCAP_EXPORT int xccdf_session_build_policy_from_testresult(struct xccdf_session *session, const char *testresult_id);
 ...
 * @returns zero on success.
 */
OSCAP_EXPORT int xccdf_session_add_report_from_source(struct xccdf_session *session, struct oscap_source *report_source);
