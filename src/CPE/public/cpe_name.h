 ...
 */
OSCAP_EXPORT struct cpe_name *cpe_name_new(const char *cpe);
 ...
 * @memberof cpe_name
 */
OSCAP_EXPORT struct cpe_name * cpe_name_clone(struct cpe_name * old_name);
 ...
 */
OSCAP_EXPORT void cpe_name_free(struct cpe_name *cpe);
 ...
 * @memberof cpe_name
 */
OSCAP_EXPORT cpe_format_t cpe_name_get_format(const struct cpe_name *cpe);

/**
 * Get CPE name part type field.
 * @memberof cpe_name
 */
OSCAP_EXPORT cpe_part_t cpe_name_get_part(const struct cpe_name *cpe);

/**
 * Get CPE name vendor field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_vendor(const struct cpe_name *cpe);

/**
 * Get CPE name product field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_product(const struct cpe_name *cpe);

/**
 * Get CPE name version field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_version(const struct cpe_name *cpe);

/**
 * Get CPE name update field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_update(const struct cpe_name *cpe);

/**
 * Get CPE name edition field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_edition(const struct cpe_name *cpe);

/**
 * Get CPE name language field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_language(const struct cpe_name *cpe);

/**
 * Get CPE name sw_edition field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_sw_edition(const struct cpe_name *cpe);

/**
 * Get CPE name target_sw field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_target_sw(const struct cpe_name *cpe);

/**
 * Get CPE name target_hw field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_target_hw(const struct cpe_name *cpe);

/**
 * Get CPE name other field.
 * @memberof cpe_name
 */
OSCAP_EXPORT const char *cpe_name_get_other(const struct cpe_name *cpe);
 ...
 * @retval NULL on failure
 */
OSCAP_EXPORT char *cpe_name_get_as_format(const struct cpe_name *cpe, cpe_format_t format);
 ...
 * @retval NULL on failure
 */
OSCAP_EXPORT char *cpe_name_get_as_str(const struct cpe_name *cpe);
 ...
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_format(struct cpe_name *cpe, cpe_format_t newval);

/**
 * Set CPE name part type field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_part(struct cpe_name *cpe, cpe_part_t newval);

/**
 * Set CPE name vendor field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_vendor(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name product field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_product(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name version field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_version(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name update field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_update(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name edition field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_edition(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name language field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_language(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name sw_edition field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_sw_edition(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name target_sw field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_target_sw(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name target_hw field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_target_hw(struct cpe_name *cpe, const char *newval);

/**
 * Set CPE name other field.
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_set_other(struct cpe_name *cpe, const char *newval);
 ...
 * @memberof cpe_name
 */
OSCAP_EXPORT bool cpe_name_match_one(const struct cpe_name *cpe, const struct cpe_name *against);
 ...
 */
OSCAP_EXPORT bool cpe_name_match_cpes(const struct cpe_name *name, size_t n, struct cpe_name **namelist);
 ...
 * @retval <0 on failure
 */
OSCAP_EXPORT int cpe_name_write(const struct cpe_name *cpe, FILE * f);
 ...
 */
OSCAP_EXPORT cpe_format_t cpe_name_get_format_of_str(const char *str);
 ...
 */
OSCAP_EXPORT bool cpe_name_check(const char *str);
 ...
 */
OSCAP_EXPORT int cpe_name_match_strs(const char *candidate, size_t n, char **targets);
 ...
 * @memberof cpe_name
 */
OSCAP_EXPORT const char * cpe_name_supported(void);
 ...
 */
OSCAP_EXPORT typedef bool *(*cpe_check_fn) (const char*, const char*, const char*, void*);
 ...
 */
OSCAP_EXPORT typedef bool *(*cpe_dict_fn) (const struct cpe_name*, void*);
