 ...
 */
OSCAP_EXPORT oval_probe_session_t *oval_probe_session_new(struct oval_syschar_model *model);

/**
 * Reinitialize already allocated probe session inplace
 * @param model system characteristics model
 */
OSCAP_EXPORT void oval_probe_session_reinit(oval_probe_session_t *sess, struct oval_syschar_model *model);
 ...
 */
OSCAP_EXPORT void oval_probe_session_destroy(oval_probe_session_t *sess);
 ...
 * @param sess pointer to the probe session structure
 */
OSCAP_EXPORT int oval_probe_session_close(oval_probe_session_t *sess);
 ...
 */
OSCAP_EXPORT int oval_probe_session_reset(oval_probe_session_t *sess, struct oval_syschar_model *sysch);

/**
 * Abort the session.
 */
OSCAP_EXPORT int oval_probe_session_abort(oval_probe_session_t *sess);
 ...
 */
OSCAP_EXPORT int oval_probe_session_sethandler(oval_probe_session_t *sess, oval_subtype_t type, oval_probe_handler_t handler, void *ptr);

/**
 * Get system characteristics model from probe session.
 * @param sess pointer to the probe session structure
 */
OSCAP_EXPORT struct oval_syschar_model *oval_probe_session_getmodel(oval_probe_session_t *sess);
