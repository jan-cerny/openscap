 ...
 */
OSCAP_EXPORT int oval_probe_query_sysinfo(oval_probe_session_t *sess, struct oval_sysinfo **out_sysinfo) __attribute__ ((nonnull(1, 2)));
 ...
 */
OSCAP_EXPORT int oval_probe_query_object(oval_probe_session_t *psess, struct oval_object *object, int flags, struct oval_syschar **out_syschar) __attribute__ ((nonnull(1, 2)));
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int oval_probe_query_definition(oval_probe_session_t *sess, const char *id)) __attribute__ ((nonnull(1, 2)));
 ...
 * @return 0 on success
 */
OSCAP_EXPORT int oval_probe_query_variable(oval_probe_session_t *sess, struct oval_variable *variable);
...
OSCAP_EXPORT void oval_probe_meta_list(FILE *output, int flags);

OSCAP_EXPORT const char *oval_probe_ext_getdir(void);
#endif				/* OVAL_PROBE_H */
/// @}
