 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(oval_version_t oval_version_from_cstr(const char *version_str));
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int oval_version_to_cstr(oval_version_t version, char *buffer, size_t buflen));

/**
 * Get the major component of the version
 */
OSCAP_EXPORT OSCAP_DEPRECATED(uint8_t oval_version_major(oval_version_t version));

/**
 * Get the minor component of the version
 */
OSCAP_EXPORT OSCAP_DEPRECATED(uint8_t oval_version_minor(oval_version_t version));

/**
 * Get the patch component of the version
 */
OSCAP_EXPORT OSCAP_DEPRECATED(uint8_t oval_version_patch(oval_version_t version));
 ...
 */
OSCAP_EXPORT OSCAP_DEPRECATED(int oval_version_cmp(oval_version_t v1, oval_version_t v2));
