 ...
 */
OSCAP_EXPORT struct oval_session *oval_session_new(const char *filename);
 ...
 */
OSCAP_EXPORT void oval_session_set_variables(struct oval_session *session, const char *filename);
 ...
 */
OSCAP_EXPORT void oval_session_set_directives(struct oval_session *session, const char *filename);
 ...
 */
OSCAP_EXPORT void oval_session_set_validation(struct oval_session *session, bool validate, bool full_validation);
 ...
 */
OSCAP_EXPORT void oval_session_set_datastream_id(struct oval_session *session, const char *id);
 ...
 * @param id an id of a definition
 */
OSCAP_EXPORT void oval_session_set_component_id(struct oval_session *session, const char *id);
 ...
 */
OSCAP_EXPORT void oval_session_set_results_export(struct oval_session *session, const char *filename);
 ...
 * @param filename a path to a new file
 */
OSCAP_EXPORT void oval_session_set_report_export(struct oval_session *session, const char *filename);
 ...
 */
OSCAP_EXPORT void oval_session_set_xml_reporter(struct oval_session *session, xml_reporter fn);
 ...
 * oscap_err_get_full_error to get more details)
 */
OSCAP_EXPORT int oval_session_load(struct oval_session *session);
 ...
 * oscap_err_get_full_error to get more details)
 */
OSCAP_EXPORT int oval_session_evaluate_id(struct oval_session *session, char *probe_root, const char *id, oval_result_t *result);
 ...
 * oscap_err_get_full_error to get more details)
 */
OSCAP_EXPORT int oval_session_evaluate(struct oval_session *session, char *probe_root, agent_reporter fn, void *arg);
 ...
 * oscap_err_get_full_error to get more details)
 */
OSCAP_EXPORT int oval_session_export(struct oval_session *session);
 ...
 */
OSCAP_EXPORT void oval_session_set_export_system_characteristics(struct oval_session *session, bool export);
 ...
 */
OSCAP_EXPORT void oval_session_set_remote_resources(struct oval_session *session, bool allowed, download_progress_calllback_t callback);
 ...
 */
OSCAP_EXPORT void oval_session_free(struct oval_session *session);
