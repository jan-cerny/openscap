 ...
 */
OSCAP_EXPORT oval_schema_version_t oval_schema_version_from_cstr(const char *ver_str);
 ...
 */
OSCAP_EXPORT const char *oval_schema_version_to_cstr(oval_schema_version_t version);
 ...
 */
OSCAP_EXPORT int oval_schema_version_cmp(oval_schema_version_t v1, oval_schema_version_t v2);
