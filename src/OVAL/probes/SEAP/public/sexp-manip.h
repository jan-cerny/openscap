 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_number_new (SEXP_numtype_t t, const void *n) __attribute__ ((nonnull (2)));

/**
 * Create a new sexp object from a boolean value.
 * @param n the boolean value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newb (bool n);

/**
 * Create a new sexp object from an integer.
 * @param n the integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newi_8 (int8_t n);

/**
 * Create a new sexp object from an unsigned integer.
 * @param n the unsigned integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newu_8 (uint8_t n);

/**
 * Get unsigned integer value from a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT uint8_t SEXP_number_getu_8 (const SEXP_t *s_exp);

/**
 * Create a new sexp object from an integer.
 * @param n the integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newi_16 (int16_t n);

/**
 * Create a new sexp object from an unsigned integer.
 * @param n the unsigned integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newu_16 (uint16_t n);
 ...
 * @param n the integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newi_32 (int32_t n);
 ...
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT int32_t SEXP_number_geti_32 (const SEXP_t *s_exp);

/**
 * Get boolean value from a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT bool SEXP_number_getb (const SEXP_t *s_exp);
 ...
 * @param n the integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newu_32 (uint32_t n);
 ...
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT uint32_t SEXP_number_getu_32 (const SEXP_t *s_exp);

/**
 * Create a new sexp object from an integer.
 * @param n the integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newi_64 (int64_t n);

/**
 * Get integer value from a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT int64_t SEXP_number_geti_64 (const SEXP_t *s_exp);

/**
 * Create a new sexp object from an unsigned integer.
 * @param n the integer value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newu_64 (uint64_t n);

/**
 * Get unsigned integer value from a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT uint64_t SEXP_number_getu_64 (const SEXP_t *s_exp);

/**
 * Create a new sexp object from an floating point value.
 * @param n the floating point value to store
 */
OSCAP_EXPORT SEXP_t *SEXP_number_newf (double n);

/**
 * Get floating point value from a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT double  SEXP_number_getf (const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT int SEXP_number_get (const SEXP_t *s_exp, void *dst, SEXP_numtype_t type);

/**
 * Get unsigned integer value from a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT uint16_t SEXP_number_getu_16 (const SEXP_t *s_exp);

/**
 * Free the specified sexp object.
 * @param s_exp the object to be freed
 */
OSCAP_EXPORT void    SEXP_number_free (SEXP_t *s_exp);

/**
 * Check whether the provided sexp object is a number.
 * @param s_exp the sexp object to be tested
 */
OSCAP_EXPORT bool    SEXP_numberp (const SEXP_t *s_exp);

/**
 * Get the number type of an object.
 * @param sexp the queried sexp object
 */
OSCAP_EXPORT SEXP_numtype_t SEXP_number_type (const SEXP_t *sexp);
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_string_new  (const void *string, size_t strlen) __attribute__ ((nonnull (1)));
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_string_newf (const char *format, ...) __attribute__ ((format (printf, 1, 2), nonnull (1)));

/**
 * Free the specified sexp object.
 * @param s_exp the object to be freed
 */
OSCAP_EXPORT void SEXP_string_free (SEXP_t *s_exp);

/**
 * Check whether the provided sexp object is a string.
 * @param s_exp the sexp object to be tested
 */
OSCAP_EXPORT bool SEXP_stringp (const SEXP_t *s_exp);

/**
 * Get the length of a string in a sexp object.
 * @param s_exp the queried sexp object
 */
OSCAP_EXPORT size_t SEXP_string_length (const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT int SEXP_strcmp (const SEXP_t *s_exp, const char *str) __attribute__ ((nonnull (2)));
 ...
 */
OSCAP_EXPORT int SEXP_strncmp (const SEXP_t *s_exp, const char *str, size_t n) __attribute__ ((nonnull (2)));
 ...
 */
OSCAP_EXPORT int SEXP_string_nth (const SEXP_t *s_exp, size_t n);

/**
 * Get a C string from a sexp object.
 */
OSCAP_EXPORT char  *SEXP_string_cstr (const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT size_t SEXP_string_cstr_r (const SEXP_t *s_exp, char *buf, size_t len) __attribute__ ((nonnull (2)));

/**
 * Obsolete function.
 */
OSCAP_EXPORT char  *SEXP_string_cstrp (const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT char *SEXP_string_subcstr (const SEXP_t *s_exp, size_t beg, size_t len);
 ...
 */
OSCAP_EXPORT int SEXP_string_cmp (const SEXP_t *str_a, const SEXP_t *str_b);

/**
 * Try to cast the supplied sexp string to a boolean.
 * @param s_ext the string to be cast
 */
OSCAP_EXPORT bool SEXP_string_getb (const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_list_new (SEXP_t *memb, ...);

/**
 * Free the specified sexp object.
 * @param s_exp the object to be freed
 */
OSCAP_EXPORT void    SEXP_list_free (SEXP_t *s_exp);

/**
 * Check whether the provided sexp object is a list.
 * @param s_exp the sexp object to be tested
 */
OSCAP_EXPORT bool    SEXP_listp (const SEXP_t *s_exp);

/**
 * Get the length of the sexp list.
 * @param s_sexp the queried sexp object
 */
OSCAP_EXPORT size_t  SEXP_list_length (const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_list_first (const SEXP_t *list);
 ...
 * @param list the queried sexp object
 */
OSCAP_EXPORT SEXP_t *SEXP_list_rest  (const SEXP_t *list);
 ...
 * @param list the queried sexp object
 */
OSCAP_EXPORT SEXP_t *SEXP_list_last (const SEXP_t *list);
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_list_nth (const SEXP_t *list, uint32_t n);
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_list_add (SEXP_t *list, const SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_list_join (const SEXP_t *list_a, const SEXP_t *list_b);
 ...
 * @param s_exp the element to be added
 */
OSCAP_EXPORT SEXP_t *SEXP_list_push (SEXP_t *list, const SEXP_t *s_exp);
 ...
 * @param list the modified sexp object
 */
OSCAP_EXPORT SEXP_t *SEXP_list_pop (SEXP_t *list);

/**
 * Sort a list using `compare' as the comparison function.
 */
OSCAP_EXPORT SEXP_t *SEXP_list_sort(SEXP_t *list, int(*compare)(const SEXP_t *, const SEXP_t *));
 ...
 */
OSCAP_EXPORT SEXP_t *SEXP_list_replace (SEXP_t *list, uint32_t n, const SEXP_t *s_exp);
 ...
 * @param list the queried sexp object
 */
OSCAP_EXPORT SEXP_t *SEXP_listref_first (SEXP_t *list);
 ...
 * @param list the queried sexp object
 */
OSCAP_EXPORT SEXP_t *SEXP_listref_rest (SEXP_t *list);
 ...
 * @param list the queried sexp object
 */
OSCAP_EXPORT SEXP_t *SEXP_listref_last (SEXP_t *list);
 ...
 * @param n the position of the element in the list
 */
OSCAP_EXPORT SEXP_t *SEXP_listref_nth (SEXP_t *list, uint32_t n);
...
OSCAP_EXPORT SEXP_it_t *SEXP_listit_new (const SEXP_t *list, int flags);
OSCAP_EXPORT SEXP_t    *SEXP_listit_next(SEXP_it_t *it);
OSCAP_EXPORT SEXP_t    *SEXP_listit_prev (SEXP_it_t *it);
OSCAP_EXPORT SEXP_t    *SEXP_listit_length (SEXP_it_t *it);
OSCAP_EXPORT SEXP_t    *SEXP_listit_seek (SEXP_it_t *it, uint32_t n);
OSCAP_EXPORT void       SEXP_listit_free (SEXP_it_t *it);

typedef struct SEXP_list_it SEXP_list_it;

OSCAP_EXPORT SEXP_list_it *SEXP_list_it_new(const SEXP_t *list);
OSCAP_EXPORT SEXP_t *SEXP_list_it_next(SEXP_list_it *it);
OSCAP_EXPORT void SEXP_list_it_free(SEXP_list_it *it);
...
OSCAP_EXPORT         for (uint32_t OSCAP_CONCAT(i,__LINE__) = (beg); OSCAP_CONCAT(i,__LINE__) <= ((size_t)(end)) && ((var) = SEXP_list_nth (list, OSCAP_CONCAT(i,__LINE__))) != NULL; ++OSCAP_CONCAT(i,__LINE__), SEXP_free (var), (var) = NULL)
 ...
 * generic
 */
OSCAP_EXPORT SEXP_t *SEXP_new (void);

OSCAP_EXPORT bool SEXP_emptyp(SEXP_t *sexp);

/**
 * Create a new reference to a sexp object.
 * @param s_exp the object of which to increment the reference count
 */
OSCAP_EXPORT SEXP_t *SEXP_ref (const SEXP_t *s_exp);

OSCAP_EXPORT SEXP_t *SEXP_unref (SEXP_t *s_exp_o);

/**
 * Create a new soft reference to a sexp object.
 * @param s_exp the object to which create the soft reference
 */
OSCAP_EXPORT SEXP_t *SEXP_softref (SEXP_t *s_exp);

/**
 * Check whether an S-exp reference is a "soft" reference
 * @param s_exp the S-exp reference
 */
OSCAP_EXPORT bool SEXP_softrefp(const SEXP_t *s_exp);

/**
 * Return the value of the reference counter
 * @param ref
 */
OSCAP_EXPORT uint32_t SEXP_refs (const SEXP_t *ref);

OSCAP_EXPORT bool SEXP_eq (const SEXP_t *a, const SEXP_t *b);

/**
 * Compare reference pointers.
 */
OSCAP_EXPORT int SEXP_refcmp(const SEXP_t *a, const SEXP_t *b);

OSCAP_EXPORT bool SEXP_deepcmp(const SEXP_t *a, const SEXP_t *b);
...
OSCAP_EXPORT 		size_t __svfc##__LINE__ = sizeof (__svf##__LINE__)/sizeof(SEXP_t *); \
		for (; __svfc##__LINE__ > 0; --__svfc##__LINE__) \
			if (__svf##__LINE__[__svfc##__LINE__ - 1]) \
OSCAP_EXPORT 				SEXP_free(__svf##__LINE__[__svfc##__LINE__ - 1]); \
	} while(0)
#endif /* __COVERITY__ */
 ...
 * @param s_exp the object to be freed
 */
OSCAP_EXPORT void     SEXP_free (SEXP_t *s_exp);
 ...
 */
OSCAP_EXPORT void     __SEXP_vfree (int n, SEXP_t *s_exp, ...);
#ifdef __COVERITY__
...
OSCAP_EXPORT void     __SEXP_free (SEXP_t *s_exp, const char *file, uint32_t line, const char *func);
#ifdef __COVERITY__
# define SEXP_vfree(...) SEXP_vfree_coverity(__VA_ARGS__)
#else
# define SEXP_vfree(...) __SEXP_vfree (__FILE__, __LINE__, __PRETTY_FUNCTION__, PP_NARG(__VA_ARGS__), __VA_ARGS__)
#endif
OSCAP_EXPORT void     __SEXP_vfree (const char *file, uint32_t line, const char *func, int n, SEXP_t *s_exp, ...);
#endif
 ...
 */
OSCAP_EXPORT const char *SEXP_datatype (const SEXP_t *s_exp);

/**
 * Set the user data type of a sexp object.
 * @param s_exp the object to be modified
 */
OSCAP_EXPORT int SEXP_datatype_set (SEXP_t *s_exp, const char *name) __attribute__ ((nonnull (2)));
 ...
 */
OSCAP_EXPORT int SEXP_datatype_set_nth (SEXP_t *list, uint32_t n, const char *name) __attribute__ ((nonnull (3)));

/**
 * Get the type of a sexp object.
 * @param s_exp the object to be queried
 */
OSCAP_EXPORT SEXP_type_t SEXP_typeof (const SEXP_t *s_exp);

/**
 * Get a text description of the sexp object's type.
 * @param s_exp the object to be queried
 */
OSCAP_EXPORT const char *SEXP_strtype (const SEXP_t *s_exp);

OSCAP_EXPORT SEXP_t *SEXP_build (const char *s_str, ...);

OSCAP_EXPORT size_t SEXP_sizeof (const SEXP_t *s_exp);

#if !defined(NDEBUG)
# define SEXP_VALIDATE(s) __SEXP_VALIDATE(s, __FILE__, __LINE__, __PRETTY_FUNCTION__)
# include <stdlib.h>

OSCAP_EXPORT void __SEXP_VALIDATE(const SEXP_t *s_exp, const char *file, uint32_t line, const char *func);
