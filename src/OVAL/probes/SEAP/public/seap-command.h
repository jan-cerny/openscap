...
OSCAP_EXPORT typedef SEXP_t * (*SEAP_cmdfn_t) (SEXP_t *, void *);
...
OSCAP_EXPORT int SEAP_cmd_register   (SEAP_CTX_t *ctx, SEAP_cmdcode_t code, uint32_t flags, SEAP_cmdfn_t func, ...);
OSCAP_EXPORT int SEAP_cmd_unregister (SEAP_CTX_t *ctx, SEAP_cmdcode_t code);
